  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-red-50 mt-10">
        ...
        {/* Hero Section */}
        <section id="home" className="relative overflow-hidden bg-gradient-to-r from-red-700 to-red-900 text-white">
        ...
        {/* CTA Section */}
        <section id="contact" className="py-20 bg-gradient-to-br from-red-700 to-red-900 text-white relative overflow-hidden">
          <div className="absolute inset-0  opacity-20"></div>
